...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">npm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> i</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @yx-components/components</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="_6-启动-vitepress-文档" tabindex="-1">6. 启动 VitePress 文档 <a class="header-anchor" href="#_6-启动-vitepress-文档" aria-label="Permalink to &quot;6. 启动 VitePress 文档&quot;">​</a></h3><p>在 <code>packages/docs</code> 目录下运行以下命令启动文档开发服务器：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">pnpm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> dev</span></span></code></pre></div><h3 id="_7-访问文档" tabindex="-1">7. 访问文档 <a class="header-anchor" href="#_7-访问文档" aria-label="Permalink to &quot;7. 访问文档&quot;">​</a></h3><p>打开浏览器，访问 <code>http://localhost:3000</code>，您将看到 VitePress 生成的文档页面。</p><h3 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h3><p>通过以上步骤，您已经成功在项目中引入了 VitePress，并搭建了组件库的文档。您可以根据需要继续扩展文档内容，添加更多组件的文档和示例。</p>`,18)]))}const F=a(t,[["render",e]]);export{k as __pageData,F as default};
